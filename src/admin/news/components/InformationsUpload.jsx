                ...
                <div className="flex flex-col space-y-3">
                    <form onSubmit={handleSubmit}>
                        ...
                        <input
                            ...
                            palceholder="Information Title"
                            className="border w-full h-10 rounded-xl px-2"
                        />
                        ...
                        <textarea
                            ...
                            onChange={handleChange}
                            placeholder="Content"
                            className="border min-h-[40vh] w-full rounded-xl px-2"
                        />
                    ...
                    <div className="flex gap-2 mt-5">
                        <button
                            onClick={() => navigate("/admin/informations")}
                            className="w-1/2 h-10 bg-black text-white border rounded-xl hover:bg-white hover:text-black transition duration-100"
                        >
                            Cancel
                        </button>
                        <button
