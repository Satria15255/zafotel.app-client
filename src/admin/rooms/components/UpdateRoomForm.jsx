    ...
    return (
        <div className="z-100 inset-0 flex justify-center items-center fixed bg-black/40">
            <div className="bg-white w-4/5 max-h-[90vh] overflow-y-scroll rounded-lg p-4">
                <p className="text-xl text-center font-serif mt-3">
                    Update Room
                </p>
                <div>
                    <form onSubmit={handleSubmit}>
                        ...
                        <div>
                            <label className="font-semibold">
                                Picture of the Room (Max 4 Picture)
                            </label>
                        ...
                        <div className="flex gap-2 mt-6">
                            <button
                                type="submit"
                                className="w-1/2 rounded-xl h-10 bg-gray-900 text-white hover:bg-white hover:text-black transition duration-100 border"
                            >
                                Update
                            </button>
                            <button
