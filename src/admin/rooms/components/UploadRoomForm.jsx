                    ...
                    <form onSubmit={handleSubmit}>
                        <div>
                            ...
                            <input
                                ...
                                className="w-full border h-10 px-2 rounded-lg"
                        ...
                        <div>
                            ...
                            <input
                                ...
                                onChange={handleChange}
                                className="w-full border h-10 px-2 rounded-lg"
                                placeholder="Ex. Lorem ipsum dolor, sit amet consectetur adipisicing elit. Maiores voluptatibus consequatur dolorem?"
                            />
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input
                                ...
                                onChange={handleChange}
                                className="w-full border h-10 px-2 rounded-lg"
                                placeholder="Ex. TV, AC, Balkon, Bathup"
                            />
                        </div>
                        <div>
                            <label className="font-semibold mb-2">
                            ...
                            <input
                                ...
                                onChange={handleChange}
                                className="w-full border h-10 px-2 rounded-lg"
                                placeholder="Ex. Gym, Breakfast, Airport Shuffle"
                            />
                        </div>
                        <div>
                            <label className="font-semibold mb-2">
                                Picture of the Room ( 4 Picture )
                            </label>
                        ...
                        <div className="flex gap-2">
                            <button
                                ...
                                className="mt-3 h-10 w-20 rounded-xl bg-gray-900 text-white border hover:bg-white hover:text-black transition duration-100"
                            >
                                Cancel
                            </button>
                            <button
