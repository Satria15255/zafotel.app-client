...
import RoomsTable from "@/admin/rooms/components/RoomsTable";
...
const RoomManagement = () => {
    ...
    return (
        <div className="w-full">
            <div>
                <p className="font-serif text-xl text-center p-5">
                    Rooms Management Page
                </p>
            </div>
            <RoomsTable
                room={room}
                onEdit={(room) => setUpdateRoom(room)}
            ...
            <div className="px-5 fixed right-0">
                <button
                    onClick={() => navigate("/admin/rooms/upload")}
                    className="h-10 w-40 text-sm border rounded-xl hover:bg-black hover:text-white"
                >
                    Upload New Room
                </button>
            </div>
