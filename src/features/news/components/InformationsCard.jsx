        ...
        <div className="w-full h-auto">
            <div className="w-60 lg:w-100 h-auto hidden md:flex rounded-xs border border-gray-300 shadow-lg cursor-pointer">
                <div className="flex flex-col justify-between">
                    ...
                    <div className="p-4">
                        ...
                        <p className="text-[10px] lg:text-sm text-gray-500 py-4">
                            {new Date(
                        ...
                        <button
                            onClick={() =>
                                navigate(`/informations/${informations._id}`)
                            }
                            className="border py-2 px-6 text-[10px] lg:text-xs bg-gray-900 text-white rounded-xs hover:bg-white hover:text-black transition duration-100"
                        >
                            Read More —▸
                        </button>
                    </div>
            ...
            <div className="md:hidden p-2 border-b">
                <div className="w-full h-auto py-2  rounded-xs cursor-pointer">
                    <div
                        className="flex"
                        onClick={() => navigate(`/news/${informations._id}`)}
                    >
                        ...
                        <div className="w-3/5 flex flex-col justify-center pl-4">
                            <p className="text-sm lg:text-sm max-w-xs h-10 font-semibold">
                                {informations.title}
                            </p>
                            <p className="text-[10px] lg:text-sm text-gray-500 py-4">
                                {new Date(
