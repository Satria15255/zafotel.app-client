                        ...
                        <div className="flex flex-col w-full md:w-3/5">
                            ...
                            <Motion delay={0.8}>
                                <div className="w-full h-auto flex flex-col justify-between border rounded-xl py-2 px-3 ">
                                    <div className="flex flex-col justify-center ">
                                        <p className="flex justify-between items-center text-sm md:text-md">
                                            {" "}
                            ...
                            <Motion>
                                <div className="space-y-3">
                                    ...
                                    <p className="text-sm max-w-lg">
                                        Some of the room facilities that you get
                                        exclusively include:
                                    </p>
                                    <div className="grid grid-cols-2">
                                        {room.details.amenities.map(
                                            (amenities) => {
                                                const key = amenities
                                                    .toLowerCase()
                                                    .trim();
                                                return (
                                                    ...
                                                    >
                                                        {FacilityIcon[key]}
                                                        <p className="text-xs md:text-lg flex items-center py-3">
                                                            {amenities}
                                                        </p>
                                                    </div>
                                                );
