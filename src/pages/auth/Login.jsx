    ...
    return (
        ...
        >
            <div className="w-4/5 md:w-120 h-auto  border rounded-xl p-5 z-50 inset-0 bg-transparent backdrop-blur">
                <p
                    onClick={() => navigate("/")}
                    className="text-white text-left mb-2 cursor-pointer"
                >
                    X
                </p>
                ...
                <div className="flex flex-col w-full h-auto text-white">
                    <form
                        ...
                        className="flex flex-col w-full space-y-1 md:space-y-3 text-sm"
                    >
                        <label>Email</label>
                        <input
                            value={email}
                            ...
                            type="email"
                            placeholder="Ex. jerdnonarch@gmail.com"
                            className="w-full border h-10 rounded-xl px-2 text-white"
                        />
                        ...
                        <input
                            ...
                            className="w-full border h-10 rounded-xl px-2"
                        />
                        <button
                            type="submit"
                            className="bg-yellow-400 hover:bg-gray-900 hover:text-white transition duration-100 font-serif py-2 rounded-xl mt-5 cursor-pointer"
                        >
                            Login
                        </button>
                    </form>
