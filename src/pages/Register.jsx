        ...
        <div className='h-screen flex flex-col items-center justify-center bg-cover bg-center ' style={{ backgroundImage: 'url(/assets/herobanner.jpg)' }}>
            <div className='w-4/5 md:w-120 h-auto  border rounded-xl p-5 z-50 inset-0 bg-transparent backdrop-blur'>
                ...
                <div className='flex justify-center items-center'>
                    <p className='text-white font-serif text-lg md:text-xl'>Register</p>
                </div>
                <div className='flex flex-col w-full h-auto text-white'>
                    <form onSubmit={handleSubmit} className='flex flex-col w-full space-y-1 md:space-y-3 text-sm md:text-lg'>
                        ...
                        <button type="submit" className='bg-yellow-400 hover:bg-gray-900 hover:text-white transition duration-100 font-serif py-2 rounded-xl mt-5 cursor-pointer'>Register</button>
                    </form>
                    <button onClick={() => navigate("/login")} className='text-center mt-3 text-sm cursor-pointer'>Have any account?</button>
                </div>
            </div>
        </div>
    )
