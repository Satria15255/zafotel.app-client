    ...
    return (
        <div className='w-full h-[80vh] flex items-center md:h-full bg-center bg-cover z-0' style={{ backgroundImage: 'url(/assets/herobanner.jpg)' }}>
            <div className='h-[80vh] md:h-screen flex flex-col justify-center md:items-center bg-black/20 w-full p-4'>
                ...
                <p className='text-left md:text-center text-white text-xs md:text-sm  max-w-xs md:max-w-lg mt-3'>Zafotel is here for modern professionals and travelers who need unlimited comfort amidst the hustle and bustle of the city.</p>
                <div className='mt-3'>
