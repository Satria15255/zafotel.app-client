    ...
    return (
        <div className='h-auto pb-6 bg-[#FFFFF0]'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-2 p-4 place-items-center cursor-default'>
                {facilities.map((f) => (
                    <Motion delay={0.4}>
                        <div className='bg-white w-90 md:w-110 h-50 gap-4 hover:text-[#FFD700] transition duration-100 flex justify-center items-center font-semibold border'>
                            <span className="text-7xl text-yellow-500">{f.icon}</span>
