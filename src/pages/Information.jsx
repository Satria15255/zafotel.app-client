...
const Information = () => {
    ...
    return (
        <div className='h-auto pb-6'>
            ...
            <div className='w-full h-auto'>
                <div className='grid grid-cols-1 md:grid-cols-3 gap-5 place-items-center'>
                    {informations.map((info, index) => (
                        <div key={index} className='w-60 md:w-100 h-auto md:w-100 md:h-100 flex flex-col justify-between rounded-xs border border-gray-300 shadow-lg cursor-pointer'>
            ...
            <div>
                <p className='text-center py-4 text-xs md:text-lg font-serif'>Explore Other</p>
            </div>
        </div>
    )
}
