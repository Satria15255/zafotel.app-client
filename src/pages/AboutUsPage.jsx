...
const facilities = [
    ...
    },
    {
        ...
        description:
            "Our receptionist is ready to assist you whenever you need him.",
    },
    {
        id: 5,
        icon: <PiBusLight />,
    ...
    return (
        <div className="w-full h-auto">
                ...
                <div className="w-full xl:max-w-4/5">
                    <div className="grid grid-cols-1 md:grid-cols-3 place-items-center justify-around items-center space-y-4 mt-8 px-3 lg:px-6">
                        ...
                        <div className="flex items-center">
                            <div className="text-[140px] md:text-[120px] lg:text-[250px] flex items-center justify-center text-gray-200">
                                [{" "}
                                <span className="text-8xl text-black flex items-center justify-center mt-10 md:mt-8 lg:mt-14 font-bold font-sans">
                                    10
                        ...
                        <div>
                            <p className="mb-6 text-[#c69c6d] font-semibold">
                                ABOUT US
                            </p>
                            <p className="text-3xl lg:text-5xl max-w-xs font-serif">
                                Where Every Stay Feels Special.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div className="px-3 lg:px-0 mt-12">
                <Motion className="flex justify-center">
                    <div className="px-6 w-full xl:max-w-4/5">
                        <p className="text-lg md:text-xl text-[#c69c6d] font-serif mt-6">
                            WELCOME TO THERINA
                        </p>
                        <p className="text-xl md:text-3xl font-semibold py-4">
                            Luxury Hotel in the Heart of the City
                        </p>
                        <p className="font-serif text-[12px] md:text-sm lg:text-lg">
                            <span className="font-bold text-sm md:text-lg">
                                THERINA
                            </span>{" "}
                            is a place where every guest comes as a visitor and
                            leaves as family. We believe that true comfort lies
                            not only in a soft bed and a clean room, but in a
                            warm atmosphere that makes you feel at home. Enjoy
                            the tranquility, friendly service, and modern
                            amenities we provide to accompany your every
                            journey.
                        </p>
                        <p className="font-serif text-[12px] md:text-sm lg:text-lg mt-6">
                            At THERINA, we don't just provide a place to stay—we
                            create a space where you can rest, smile, and feel
                            at ease.
                        </p>
                        <div className="flex text-[#c69c6d] text-lg md:text-2xl mt-6">
                            <PiStarFill />
                            <PiStarFill />
                            <PiStarFill />
                            <PiStarFill />
                ...
                <Motion>
                    <div className="w-full">
                        <p className="text-lg text-center md:text-xl text-[#c69c6d] font-serif mt-12">
                            Why Chose THERINA?
                        </p>
                        <Superiority />
                    </div>
                ...
                <Motion>
                    <div>
                        <p className="text-lg text-center md:text-xl text-[#c69c6d] px-6 font-serif mt-12">
                            THERINA Faciities
                        </p>
                            ...
                            {facilities.map((f) => (
                                <Motion delay={0.4}>
                                    <div className="w-90 lg:w-110 h-50 gap-4 transition duration-100 flex justify-center items-center font-semibold ">
                                        <span className="text-4xl lg:text-6xl p-4 text-white bg-[#c69c6d] border rounded-xl">
                                            {f.icon}
                                        </span>
                                        <div className="flex flex-col">
                                            ...
                                            <p className="text-sm max-w-[180px] mt-2 font-light">
                                                {f.description}
                                            </p>
                                        </div>
                                    </div>
