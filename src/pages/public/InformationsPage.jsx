...
import InformationsCard from "@/features/news/components/InformationsCard";
        ...
        <section>
            {loading ? (
                ...
                <div className="w-full flex flex-col items-center">
                    <Motion variant="fadeIn" className="w-full">
                        <header
                    ...
                    <Motion>
                        <div className="grid md:grid-cols-3 place-items-center gap-4 md:p-3 lg:p-8 w-full xl:max-w-7xl">
