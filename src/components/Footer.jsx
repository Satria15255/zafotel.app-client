        ...
        <div className=' bg-gray-900 cursor-default'>
            <div className='h-auto grid grid-cols-1 md:grid-cols-4 px-5 py-7 md:place-items-center space-y-4'>
                <div>
                    ...
                    <p className='text-white text-xs lg:text-sm font-light max-w-xs mt-2'>Zafotel is here for modern professionals and travelers who need unlimited comfort amidst the hustle and bustle of the city.</p>
                </div>
                <div className='text-white text-xs lg:text-sm space-y-2'>
                    ...
                    <li className='hover:text-yellow-300 transition duration-100'>Informations</li>
                </div>
                <div className='text-white text-xs lg:text-sm space-y-2'>
