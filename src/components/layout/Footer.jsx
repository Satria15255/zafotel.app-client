...
const Footer = () => {
    return (
        <section className="relative bg-black cursor-default">
            <div className="h-120 md:h-70 grid grid-cols-1 md:grid-cols-3 place-items-center ">
                ...
                <div className="flex flex-col items-center justify-center space-y-3">
                    <p
                        onClick={() => navigate("/")}
                        className="text-xl md:text-2xl lg:text-3xl text-[#FAFAFA] font-serif cursor-pointer"
                    >
                        <span className="text-xl md:text-4xl font-serif text-[#c69c6d]">
                            T
                        </span>
                        HERINA
                        <span className="text-xl md:text-4xl font-serif text-[#c69c6d]">
                    ...
                    <div className=" flex justify-center text-white text-sm lg:text-sm space-x-4 ">
                        <p className="hover:text-yellow-300 transition duration-100 flex items-center gap-1">
                            <span>
