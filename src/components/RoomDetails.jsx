            ...
            <Motion variant="fadeIn">
                <div className='w-full h-80 md:h-full bg-cover bg-center ' style={{ backgroundImage: 'url(/assets/herobanner.jpg)' }}>
                    <div className='bg-black/50 w-full h-80 flex flex-col cursor-pointer justify-center items-center'>
                        <p className='text-4xl md:text-6xl text-white border-b border-yellow-500 pb-2'>Room Details</p>
                        <p className='text-lg md:text-xl text-white text-xs md:text-sm'><span onClick={() => navigate("/")}>Home</span> / {room.name}</p>
                    </div>
                </div>
            </Motion>
